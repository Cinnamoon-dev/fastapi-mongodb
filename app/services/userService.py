...
class UserService:
    ...
    async def _get_all_users_with_type_name(self) -> list[dict[str, Any]]:
        ...
        pipeline = [
            ...
            {"$set": {"user_type": {"$arrayElemAt": ["$user_type.name", 0]}}},
            {"$project": {"user_type_id": 0}},
        ]
